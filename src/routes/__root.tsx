...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Discover, compare, and purchase software, APIs, hosting, AI, marketing, and creator tools — all from one trusted digital marketplace." },
      { name: "author", content: "Biztrait" },
      { property: "og:title", content: "Biztrait Market" },
      { property: "og:description", content: "Software, APIs, hosting, AI, and creator tools — unified in one digital marketplace." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "Biztrait Market" },
      { name: "twitter:description", content: "Software, APIs, hosting, AI, and creator tools — unified in one digital marketplace." },
