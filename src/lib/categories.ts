...
export const CATEGORIES: Category[] = [
  ...
  },
  {
    ...
    icon: Video,
    tools: [
      { code: "6.1", name: "Twitch Affiliate Automation API" },
      { code: "6.2", name: "YouTube Creator Automation API" },
      { code: "6.3", name: "Stream Alert Automation API" },
      { code: "6.4", name: "Live Event Trigger API" },
      { code: "6.5", name: "Multi-Stream Distribution API" },
      { code: "6.6", name: "Creator Performance Analytics API" },
      { code: "6.7", name: "Subscriber & Membership Automation API" },
      { code: "6.8", name: "Stream Engagement Tracking API" },
    ],
  },
  {
    id: "ai",
    ...
    icon: Sparkles,
    tools: [
      { code: "7.1", name: "AI by Biztrait" },
      { code: "7.2", name: "AI Content Generation API" },
      { code: "7.3", name: "AI Workflow Decision Engine API" },
      { code: "7.4", name: "AI Audience Analysis API" },
      { code: "7.5", name: "AI Lead Qualification API" },
      { code: "7.6", name: "AI Social Media Optimization API" },
      { code: "7.7", name: "AI Audience Growth Automation API" },
      { code: "7.8", name: "AI Engagement Enhancement API" },
      { code: "7.9", name: "AI Conversion Optimization API" },
    ],
  },
];
